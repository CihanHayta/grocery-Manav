...
export default async function GroceryPage({ params }: Props) {
  ...
  return (
    <div className="text-black container mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-lg shodow-md overflow-hidden">
        <div className="md:flex">
          <div className="md:w-1/2 relative h-96">
            ...
            <div className="flex justify-between items-start">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-green-800"> {grocery.name} </h1>
            ...
            <div className="space-y-2 mb-6">
              ...
              <OrderButtons grocery={grocery} key={grocery._id}/>
            </div>
