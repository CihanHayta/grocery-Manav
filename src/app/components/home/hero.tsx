...
export default function Hero() {
  return (
    <div className="lg:grid lg:grid-cols-2 lg:gap-5 text-white">
      <div className="flex flex-col justify-between p-6 rounded-lg bg-gradient-to-r from-green-500 to-green-700  bg-cover bg-no-repeat">
      ...
      <div className="flex flex-col justify-between h-full p-6 rounded-lg bg-gradient-to-r from-orange-500 to-orange-600 max-lg:mt-4 max-lg:hidden bg-cover bg-no-repeat">
        ...
        <Link href="/" className="bg-white text-green-700 w-fit py-2 px-4 rounded-md hover:bg-green-50 transition">
          Organik Ürünler
        </Link>
      </div>
    </div>
